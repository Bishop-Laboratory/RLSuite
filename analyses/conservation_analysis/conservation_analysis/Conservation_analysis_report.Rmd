...
perm_test <- function(peaks, cores, genome, rlfs,chrom_sizes) {
  ...
  ##                               col_names = FALSE)
  pt <- regioneR::permTest(A=peaks, B=rlfs, ntimes=150, force.parallel = TRUE, 
  ...
  lz <- regioneR::localZScore(pt=pt, A=peaks, B=rlfs, window = 10000, step = 2500) #changed window from 5kbp to 10kbp and step from 50 to 2.5kb
...
```
-Ran with 150 permutations:
increase in pecentile -> incease in mean shifted z-score, little variation between all sets of perm_tets. Increase in the difference between observed overlaps an mean overlap of permutations 
