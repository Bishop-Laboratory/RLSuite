...
setwd("C:/Users/user/Desktop/RSeq-development/RSeq-development")
...
returnTagMatrix2(lowerbound,upperbound,rl_cons) #rl_cons yields same trends 
```
...
annotateAndUpset(lowerbound,upperbound,rl_noZero)
```
```{r}
