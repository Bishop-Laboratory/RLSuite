...
```{r,echo=FALSE, fig.show="hold", out.width="50%", message=FALSE, warning=FALSE, cache=TRUE}
lapply(test, perm_test, cores=4, genome="hg38", rlfs=hg38_rlfs, chrom_sizes=chrom_sizes_hg38)
